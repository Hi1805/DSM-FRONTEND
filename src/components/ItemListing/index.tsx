    ...
    return (
        <React.Fragment >
            <tr className="item-listing">
                ...
                <td className={styleGender}><span>{info.gender}</span></td>
                <td>{info.email}</td>
                <td>{info.class}</td>
                <td>{info.address}</td>
                <td onClick={handleMore} data-toggle="tooltip" data-placement="bottom" title="edit or delete"
